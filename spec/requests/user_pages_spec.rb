...
describe "User pages" do
  ...
  describe "index" do # tests for the user index page
    ...
    describe "profile page" do # test for showing microposts on the user show page
      let(:user) { FactoryGirl.create(:user) }
      ...
      describe "microposts" do
        ...
        it { should have_content(user.microposts.count) } # using count method through the association
      end
...
# stuff from the other file goes here
end